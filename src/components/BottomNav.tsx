...
import { Home, Users, TrendingUp, Wrench, Inbox, Radio } from "lucide-react";
...
export function BottomNav() {
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 glass border-t border-border tap">
      <div className="mx-auto max-w-xl grid grid-cols-6 px-1 pb-[max(0.25rem,env(safe-area-inset-bottom))] pt-1">
