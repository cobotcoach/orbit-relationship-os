      ...
      <div className="max-w-3xl mx-auto p-4 space-y-4">
        <header>
          <h1 className="text-2xl font-bold tracking-tight inline-flex items-center gap-2">
            <ClipboardList className="h-6 w-6 text-primary" /> Capture Log
          </h1>
          <p className="text-sm text-muted-foreground">Audit trail of every capture entering ORBIT. Refreshes every 30s.</p>
        </header>
